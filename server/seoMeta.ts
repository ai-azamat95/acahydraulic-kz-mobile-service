...
const DEFAULT_DESCRIPTION =
  "Ремонт гидравлики спецтехники в Астане. Выездной сервис по согласованию. Ремонт гидронасосов, гидромоторов, гидрораспределителей. Гарантия качества. ☎ +7 (771) 417-79-25";
const DEFAULT_TITLE = `Ремонт гидравлики спецтехники в Астане | Выездной сервис по согласованию | ${SITE_NAME}`;
...
const routeMeta: Record<string, SeoMeta> = {
  ...
  "/services": {
    ...
    description:
      "Полный спектр услуг по ремонту гидравлики: экскаваторы, бульдозеры, погрузчики, буровые установки. Выездной сервис по Казахстану. Работаем по согласованию.",
  },
  ...
  "/services/hydraulic-valves": {
    ...
    description:
      "Ремонт гидрораспределителей, предохранительных и обратных клапанов. Восстановление золотников, замена уплотнений. Выездной сервис по согласованию.",
  },
  "/services/mobile-repair": {
    title: `Выездной ремонт гидравлики спецтехники | ${SITE_NAME}`,
    description:
      "Выездной ремонт гидравлики прямо на объекте. Время выезда согласуем после обращения. Работаем по всему Казахстану по согласованию. Без простоя техники.",
  },
  "/services/gnb-repair": {
  ...
  "/services/bulldozer-repair": {
    ...
    description:
      "Ремонт гидравлики бульдозеров CAT D6, D8, Komatsu D85, D155. Гидроцилиндры, насосы, распределители. Выездной сервис по согласованию.",
  },
  ...
  "/services/emergency-service": {
    title: `Аварийный ремонт гидравлики по согласованию | ${SITE_NAME}`,
    description:
      "Аварийный выездной ремонт гидравлики спецтехники. Время выезда согласуем после обращения. Выезд по Казахстану по согласованию.",
  },
  ...
  "/services/loader-repair": {
    ...
    description:
      "Ремонт гидравлики фронтальных и вилочных погрузчиков. Гидроцилиндры, насосы, распределители. Выездной сервис по согласованию.",
  },
  ...
  "/services/drilling-repair": {
    ...
    description:
      "Ремонт гидравлики буровых установок для горнодобывающей отрасли. Выездной сервис по Казахстану. Работаем по согласованию.",
  },
  ...
  "/services/piledriver-repair": {
    ...
    description:
      "Диагностика и ремонт гидравлики сваебойных установок: насосы, лебёдки, гидромоторы, цилиндры мачты и блоки управления. Выезд по Казахстану согласовывается после обращения.",
  },
  "/services/mining-loader-repair": {
    title: `Ремонт гидравлики шахтных погрузчиков | ${SITE_NAME}`,
    description:
      "Диагностика и ремонт гидравлики шахтных погрузчиков: контур хода, насосы, гидромоторы, распределители и рабочее оборудование. Выезд по Казахстану согласовывается после обращения.",
  },
  "/services/mining-truck-repair": {
    title: `Ремонт гидравлики карьерных самосвалов | ${SITE_NAME}`,
    description:
      "Диагностика и ремонт гидравлики карьерных самосвалов: подъём кузова, рулевое управление, насосы, распределители и цилиндры. Выезд по Казахстану согласовывается после обращения.",
  },
  "/regions/astana": {
    title: `Ремонт гидравлики в Астане | Выездной сервис по согласованию | ${SITE_NAME}`,
    description:
  ...
  "/regions/karaganda": {
    ...
    description:
      "Ремонт гидравлики спецтехники в Карагандe. Специализируемся на горнодобывающей и шахтной технике. Выездной сервис по согласованию.",
  },
  "/regions/shymkent": {
    title: `Ремонт гидравлики в Шымкенте | ${SITE_NAME}`,
    description:
      "Ремонт гидравлики спецтехники в Шымкенте. Выездной сервис, диагностика и ремонт на объекте. Работаем по согласованию.",
  },
  "/regions/aktau": {
  ...
  "/contacts": {
    ...
    description:
      "Контакты ACA Hydraulic. Астана, трасса Астана–Караганда, 81. Телефон: +7 (771) 417-79-25. WhatsApp, Telegram. Работаем по согласованию.",
  },
  "/reviews": {
  ...
  "/blog/padaet-davlenie-gidravliki-ekskavatora": {
    title: `Давление в гидросистеме экскаватора: причины падения | ${SITE_NAME}`,
    description:
      "Падает давление гидравлики экскаватора? Чек-лист диагностики: холодная и горячая система, нагрузка, пилотный контур, клапаны, насос и внутренние утечки.",
  },
  ...
  "/blog/kak-opredelit-neispravnost-gidravliki": {
    title: `Не работает гидравлика спецтехники: 10 признаков | ${SITE_NAME}`,
    description:
      "Проблемы по гидравлике: слабая работа, шум, перегрев, рывки или утечка. Что проверить безопасно, какие данные записать и когда остановить технику.",
  },
  "/brands/cat": {
  ...
  "/brands/komatsu": {
    ...
    description:
      "Ремонт гидравлики Komatsu в Астане и Казахстане. Экскаваторы PC, бульдозеры D, погрузчики WA. Выездной сервис по согласованию.",
  },
  "/brands/hitachi": {
  ...
  "/brands/hyundai": {
    ...
    description:
      "Ремонт гидравлики экскаваторов Hyundai Robex в Астане. Гидронасосы, гидромоторы, распределители. Выездной сервис по согласованию.",
  },
};
...
export function getSeoMeta(urlPath: string): SeoMeta {
  ...
  if (regionMatch) {
    ...
    return {
      ...
      description: `Ремонт гидравлики спецтехники в ${cityName}. Выездной сервис, диагностика и ремонт на объекте. Работаем по согласованию по Казахстану.`,
    };
  }
