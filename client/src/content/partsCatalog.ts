...
export const catalogCopy: Record<CatalogLanguage, CatalogCopy> = {
  ru: {
    ...
    pageDescription: "Запчасти под заказ. Цену, срок и совместимость подтвердим по OEM, модели и фото шильдика.",
  ...
  kz: {
    ...
    pageDescription: "Бөлшектер тапсырыс бойынша. Баға, мерзім және сәйкестікті OEM, модель және шильдик фотосымен растаймыз.",
  ...
  en: {
    ...
    pageDescription: "Parts supplied to order. We confirm price, lead time and fitment using the OEM, model and nameplate photo.",
