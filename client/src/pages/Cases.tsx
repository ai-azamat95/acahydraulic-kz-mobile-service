    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white font-roboto">
      ...
      <section className="border-b border-white/10 bg-[#101010] py-10">
        <div className="container mx-auto grid items-center gap-6 px-4 md:grid-cols-[220px_1fr]">
          ...
          <div>
            <p className="text-sm font-bold text-[#FFC000]">Поставка двигателя · монтаж · запуск</p>
            <h2 className="mt-3 text-3xl font-bold text-white">Shantui SD32: новый Cummins NTA855</h2>
            <p className="my-4 max-w-3xl text-gray-300">Комплектный двигатель с навесным оборудованием — 12 860 000 ₸ без монтажа. Перенесли гидротрансформатор со старого двигателя, установили новый и запустили бульдозер.</p>
            <Link href="/cases/shantui-sd32-postavka-dvigatelya-cummins-nta855/" className="inline-flex min-h-12 items-center rounded bg-[#FFC000] px-5 py-3 font-bold text-black">Фото, видео и состав поставки</Link>
          </div>
        </div>
      </section>
