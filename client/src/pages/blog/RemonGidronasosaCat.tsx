  ...
  return (
    <div className="min-h-screen bg-[#111111] text-white font-roboto pt-20">
      <SEO
        ...
        description="Ремонт гидронасоса экскаватора Caterpillar CAT 320, 330, 336 в Астане. Признаки неисправности, диагностика, стоимость от 80 000 тг. Условия работ согласуем после диагностики."
        ...
        faq={[
          {
            ...
            answer:
              "Ремонт гидронасоса CAT 320 в Астане стоит от 80 000 тг. Точная стоимость зависит от степени износа и необходимых запчастей. Диагностика спецтехники от 200 000 ₸. Ремонт, запчасти и расходы на выезд — отдельно.",
          },
          {
      ...
      <article className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="bg-[#1a1a1a] border border-white/10 rounded-lg overflow-hidden mb-8">
          <table className="w-full text-sm">
            ...
            <tbody>
              {[
                ["Диагностика спецтехники", "от 200 000 ₸"],
        ...
        <div className="bg-[#FFC000]/10 border border-[#FFC000]/20 rounded-lg p-6 mb-10">
          <p className="text-gray-300 text-sm leading-relaxed">
            <strong className="text-[#FFC000]">Важно:</strong> Стоимость ремонта гидронасоса CAT указана ориентировочно и зависит от степени износа, модели и необходимых запчастей. Стоимость диагностики спецтехники — от 200 000 ₸. Ремонт, запчасти и расходы на выезд рассчитываются отдельно. Условия гарантии согласуются по составу работ.
          </p>
        </div>
        ...
        <div className="bg-[#1a1a1a] border border-[#FFC000]/30 rounded-xl p-8 text-center">
          ...
          <p className="text-gray-400 mb-6 text-sm">
            Диагностика спецтехники от 200 000 ₸. Ремонт, запчасти и расходы на выезд — отдельно.
          </p>
