...
export default function PadaetDavlenieGidravliki() {
  const articleSchema = {
    ...
    "@type": "BlogPosting",
    headline: "Падает давление в гидросистеме экскаватора: причины и диагностика",
    description:
      "Почему падает давление в гидросистеме экскаватора, какие симптомы записать и какие измерения помогают найти неисправный контур без замены узлов наугад.",
  ...
  return (
    <div className="min-h-screen bg-[#111111] text-white font-roboto pt-20">
      <SEO
        title="Давление в гидросистеме экскаватора: причины падения | ACA Hydraulic"
        description="Падает давление гидравлики экскаватора? Чек-лист диагностики: холодная и горячая система, нагрузка, пилотный контур, клапаны, насос и внутренние утечки."
        ...
        faq={[
          ...
          {
            question: "Нужно ли сразу менять гидронасос, если давление низкое?",
            answer:
              "Нет. Низкое давление может быть связано с настройкой или неисправностью клапана, регулятором насоса, пилотным контуром, внутренней утечкой в распределителе или исполнительном узле, а также с электрическим управлением. Сначала локализуют потерю измерениями под нагрузкой.",
          },
        ]}
      />
      ...
      <article className="max-w-3xl mx-auto px-4 py-12">
        ...
        <h1 className="font-bebas text-4xl md:text-5xl mb-6 leading-tight">
          Падает давление в гидросистеме экскаватора: что проверять
        </h1>

        <p className="text-gray-300 text-lg mb-8 leading-relaxed">
          Если экскаватор стал медленным, не тянет под нагрузкой, слабеет после прогрева, дёргается или одна операция заметно отличается от остальных, это ещё не доказывает поломку насоса. Сначала нужно определить, в каком контуре и при каких условиях падает давление или пропадает управление.
        </p>
        ...
        <h2 className="font-bebas text-3xl text-[#FFC000] mb-4">Что записать до начала диагностики</h2>
        <p className="text-gray-300 mb-4 leading-relaxed">
          Один и тот же симптом может возникать по разным причинам. До измерений зафиксируйте условия, при которых проблема повторяется: это сокращает поиск и помогает не менять исправные узлы.
        </p>
        <div className="overflow-x-auto mb-10">
          <table className="w-full min-w-[640px] border-collapse text-sm">
            <thead>
              <tr className="bg-[#1a1a1a] text-left">
                <th className="border border-white/10 p-3 text-white">Наблюдение</th>
                <th className="border border-white/10 p-3 text-white">Что это помогает разделить</th>
                <th className="border border-white/10 p-3 text-white">Что сравнить</th>
              </tr>
            </thead>
            <tbody className="text-gray-300">
              <tr>
                <td className="border border-white/10 p-3">Слабая вся гидравлика или одна операция</td>
                <td className="border border-white/10 p-3">Общая проблема питания системы или отдельный контур</td>
                <td className="border border-white/10 p-3">Давление и скорость нескольких операций</td>
              </tr>
              <tr>
                <td className="border border-white/10 p-3">На холодную или после прогрева</td>
                <td className="border border-white/10 p-3">Влияние вязкости масла и внутренних утечек</td>
                <td className="border border-white/10 p-3">Параметры при одинаковой нагрузке до и после прогрева</td>
              </tr>
              <tr>
                <td className="border border-white/10 p-3">Под нагрузкой или без нагрузки</td>
                <td className="border border-white/10 p-3">Работу регулятора, клапанов и насоса в рабочем режиме</td>
                <td className="border border-white/10 p-3">Давление, управляющий сигнал и реакцию машины</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <h2 className="font-bebas text-3xl text-[#FFC000] mb-4">Порядок диагностики без замены деталей наугад</h2>
        <ol className="space-y-3 mb-10 text-gray-300 text-sm leading-relaxed list-decimal pl-5">
          <li>Повторить симптом и записать, какие операции слабеют, при какой температуре масла и под какой нагрузкой.</li>
          <li>Проверить уровень и состояние масла, фильтры, всасывающую линию, наружные утечки и доступные коды ошибок.</li>
          <li>Измерить основное и пилотное давление в контрольных точках и режимах, указанных для конкретной модели.</li>
          <li>Сопоставить давление с управляющими сигналами, работой регулятора, клапанов и соленоидов.</li>
          <li>Проверить слив и внутренние утечки подозреваемого узла, а затем подтвердить дефект перед ремонтом или заменой.</li>
        </ol>
