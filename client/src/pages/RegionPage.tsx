...
const regionsConfig: Record<string, {
  ...
  'atyrau': {
    ...
    seoDescription: "Выездная диагностика и ремонт гидравлики спецтехники в Атырау. Возможность работ, допуск на объект и сроки выезда согласуем заранее.",
    heroImage: "/images/service-van.webp",
    industries: [
...
export default function RegionPage() {
  ...
  return (
    <RegionalPageTemplate
      ...
      faq={[
        { question: `Как узнать стоимость выезда в г. ${regionData.city}?`, answer: 'Укажите точное местонахождение техники, марку, модель и признаки неисправности. Стоимость выезда и диагностики согласуем до приезда специалистов.' },
        { question: 'Входит ли ремонт в стоимость диагностики?', answer: 'Выезд, диагностика, ремонт и запчасти рассчитываются отдельно. Объём ремонта и его стоимость согласуем после определения неисправности, до начала ремонтных работ.' },
        { question: 'Что подготовить для обращения?', answer: 'Сообщите модель техники, описание проблемы и адрес объекта. Если есть фотографии шильдика, узла или дефектовочная ведомость, их можно отправить в WhatsApp после начала переписки.' },
      ]}
    />
  );
}
