...
export default function ManipulatorRepair() {
  ...
  return (
    <div className="min-h-screen bg-[#111111] text-white font-roboto pt-20">
      ...
      <div className="container mx-auto px-4 py-4 text-sm text-gray-500">
        ...
        <span className="mx-2">/</span>
        <span className="text-white">Ремонт манипуляторов</span>
      </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-[#1a1a1a] p-6 rounded border border-white/10 hover:border-[#FFC000]/30 transition-colors">
              ...
              <h3 className="font-bebas text-2xl uppercase mb-3">Гидравлическая система крана</h3>
              <p className="text-gray-400 leading-relaxed">
                Гидроцилиндры выдвижения стрелы, телескопирования, поворота. Устранение утечек, восстановление грузоподъёмности.
              </p>
            </div>

            <div className="bg-[#1a1a1a] p-6 rounded border border-white/10 hover:border-[#FFC000]/30 transition-colors">
              <Gauge className="text-[#FFC000] mb-4" size={32} />
              <h3 className="font-bebas text-2xl uppercase mb-3">Гидронасосы и распределители</h3>
              <p className="text-gray-400 leading-relaxed">
                Насосные станции, многосекционные распределители, клапаны безопасности. Диагностика и капитальный ремонт.
              </p>
            </div>

            <div className="bg-[#1a1a1a] p-6 rounded border border-white/10 hover:border-[#FFC000]/30 transition-colors">
              <Settings className="text-[#FFC000] mb-4" size={32} />
              <h3 className="font-bebas text-2xl uppercase mb-3">Поворотная платформа</h3>
              <p className="text-gray-400 leading-relaxed">
                Гидромоторы поворота, редукторы, опорно-поворотные устройства. Восстановление плавности вращения.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-400 leading-relaxed">
                Обслуживание строительных и логистических компаний. Понимание специфики работы манипуляторов в коммерческой эксплуатации.
              </p>
            </div>
      ...
      <Dialog open={isFormOpen} onOpenChange={setIsFormOpen}>
        <DialogContent className="bg-[#1a1a1a] text-white border-white/10">
          ...
          <form className="space-y-4">
            ...
            <div>
              <Label htmlFor="equipment">Модель манипулятора</Label>
