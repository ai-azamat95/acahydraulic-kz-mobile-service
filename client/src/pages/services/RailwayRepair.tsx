...
import { Phone, CheckCircle2, Wrench, AlertTriangle, Settings } from "lucide-react";
...
export default function RailwayRepair() {
  ...
  return (
    <div className="min-h-screen bg-[#111111] text-white font-roboto pt-20">
      <div className="container mx-auto px-4 py-4 text-sm text-gray-500">
        ...
        <span className="mx-2">/</span>
        <span className="text-white">Ремонт железнодорожной техники</span>
      </div>
        ...
        <div className="container mx-auto px-4 relative z-20">
          <div className="max-w-3xl">
            ...
            <h1 className="font-bebas font-bold text-4xl md:text-6xl leading-[0.95] mb-6 uppercase">
              ...
              <span className="text-[#FFC000]">железнодорожной техники</span>
            </h1>
            <p className="text-lg md:text-xl text-gray-300 mb-8 max-w-2xl leading-relaxed">
              Восстановление гидравлических систем путевой и ремонтной техники. Работаем по договору с НДС. Выездной сервис на депо и объекты.
            </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-[#1a1a1a] p-6 rounded border border-white/10 hover:border-[#FFC000]/30 transition-colors">
              ...
              <h3 className="font-bebas text-2xl uppercase mb-3">Путевая техника</h3>
              <p className="text-gray-400 leading-relaxed">
                Гидравлические системы рельсосварочных машин, дрезин, мотовозов. Устранение утечек, восстановление параметров.
              </p>
            </div>

            <div className="bg-[#1a1a1a] p-6 rounded border border-white/10 hover:border-[#FFC000]/30 transition-colors">
              <Settings className="text-[#FFC000] mb-4" size={32} />
              <h3 className="font-bebas text-2xl uppercase mb-3">Ремонтная техника</h3>
              <p className="text-gray-400 leading-relaxed">
                Гидравлика кранов, подъёмников, домкратов. Диагностика и капитальный ремонт гидрокомпонентов.
              </p>
            </div>
            ...
            <div className="bg-[#1a1a1a] p-6 rounded border border-white/10 hover:border-[#FFC000]/30 transition-colors">
              ...
              <p className="text-gray-400 leading-relaxed">
                Официальное оформление с НДС. Полный пакет документов для железнодорожных предприятий.
              </p>
            </div>
            ...
            <div className="bg-[#1a1a1a] p-6 rounded border border-white/10 hover:border-[#FFC000]/30 transition-colors">
              ...
              <p className="text-gray-400 leading-relaxed">
                Выездная бригада на депо и объекты. Устранение критических неисправностей. Минимизация простоев.
              </p>
            </div>
          </div>
        </div>
