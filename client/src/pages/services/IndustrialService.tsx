  ...
  return (
    <div className="min-h-screen bg-[#111111] text-white font-roboto">
      <SEO 
        ...
        description="Комплексное обслуживание гидравлического оборудования для строительных, горнодобывающих и промышленных предприятий. Договор, гарантии, техподдержка по согласованию."
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-gradient-to-br from-[#FFC000]/10 to-transparent p-8 rounded-2xl border border-[#FFC000]/30">
              ...
              <ul className="space-y-2 text-white/70">
                <li>• Выезд по согласованию без доплат</li>
            ...
            {[
              ...
              },
              {
                ...
                features: [
                  ...
                  "Диагностика + мониторинг по согласованию",
