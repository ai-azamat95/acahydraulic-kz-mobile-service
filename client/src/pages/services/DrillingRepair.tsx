...
export default function DrillingRepair() {
  ...
  return (
    <div className="min-h-screen bg-[#111111] text-white font-roboto pt-20">
      <div className="container mx-auto px-4 py-4 text-sm text-gray-500">
        ...
        <span className="mx-2">/</span>
        <span className="text-white">Ремонт буровых установок</span>
      </div>
      ...
      <section className="relative py-16 md:py-24 border-b border-white/10 overflow-hidden">
        <div className="absolute inset-0 bg-[#1a1a1a]">
           ...
           <div className="absolute inset-0 opacity-40 bg-cover bg-center" style={{backgroundImage: "url('https://private-us-east-1.manuscdn.com/sessionFile/qTqqkhQQWHtkSbR4kERHSj/sandbox/vkcjPNV97q5EWdEZWcDPlN-img-3_1771350243000_na1fn_YmctdmVydGljYWwtZHJpbGxpbmc.jpg?x-oss-process=image/resize,w_1920,h_1920/format,webp/quality,q_80&Expires=1798761600&Key-Pair-Id=K2HSFNDJXOU9YS&Signature=FpFazxiRPXjg02kZkUyYryxrbzdFLFO75Vhc5Wmq6gXIc9O81wdg0u3nIu2tf470BpHJSGX65Rtk6-9uvwmAFkVMj8e1HN13yON1WnHRLpdOJJuZ7vJ8tBHFaCzqVgkYEvylhmf~HC0jkDu~kR7769MZTvWb95PpyCZMwaug~LTs3oVjwAzDbVJ7xml-jfV8bNlpcxhcRMq8Ce6KErJD3qt6JK3L3-aQe2hAVLZ9d7DcZJLG9tLuwUBc-cv8QWw4NC6WkG3yEWttBEjctsxplV~qhX3WnvDb7TnlAsTeHF4wzc9eueRKz3-fhG-zzat3kcjz-CaAE73jSWX5xwl2Yg__')"}}></div>
        </div>
        ...
        <div className="container mx-auto px-4 relative z-20">
          <div className="max-w-3xl">
            ...
            <h1 className="font-bebas font-bold text-4xl md:text-6xl leading-[0.95] mb-6 uppercase">
              ...
              <span className="text-[#FFC000]">буровых установок (вертикальных)</span>
            </h1>
            <p className="text-lg md:text-xl text-gray-300 mb-8 max-w-2xl leading-relaxed">
              Восстановление гидравлических систем вертикальных буровых установок. Работаем по договору с НДС. Выездной сервис на месторождения.
            </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-[#1a1a1a] p-6 rounded border border-white/10 hover:border-[#FFC000]/30 transition-colors">
              ...
              <h3 className="font-bebas text-2xl uppercase mb-3">Гидравлическая система бурения</h3>
              <p className="text-gray-400 leading-relaxed">
                Насосы высокого давления, гидромоторы вращателя, системы подачи. Восстановление рабочих параметров.
              </p>
            </div>

            <div className="bg-[#1a1a1a] p-6 rounded border border-white/10 hover:border-[#FFC000]/30 transition-colors">
              <Settings className="text-[#FFC000] mb-4" size={32} />
              <h3 className="font-bebas text-2xl uppercase mb-3">Системы позиционирования</h3>
              <p className="text-gray-400 leading-relaxed">
                Гидроцилиндры подъёма мачты, выдвижения секций, стабилизации. Диагностика и капитальный ремонт.
              </p>
            </div>
            ...
            <div className="bg-[#1a1a1a] p-6 rounded border border-white/10 hover:border-[#FFC000]/30 transition-colors">
              ...
              <p className="text-gray-400 leading-relaxed">
                Официальное оформление с НДС. Полный пакет документов для нефтегазовых компаний.
              </p>
            </div>
            ...
            <div className="bg-[#1a1a1a] p-6 rounded border border-white/10 hover:border-[#FFC000]/30 transition-colors">
              ...
              <p className="text-gray-400 leading-relaxed">
                Мобильные бригады выезжают на месторождения. Ремонт на месте. Минимизация простоев оборудования.
              </p>
            </div>
          </div>
        </div>
      ...
      <Dialog open={isFormOpen} onOpenChange={setIsFormOpen}>
        <DialogContent className="bg-[#1a1a1a] text-white border-white/10">
          ...
          <form className="space-y-4">
            ...
            <div>
              <Label htmlFor="equipment">Модель буровой установки</Label>
