...
export default function PiledriverRepair() {
  const [isLeadFormOpen, setIsLeadFormOpen] = useState(false);

  return (
    <div className="min-h-screen bg-[#111111] text-white font-roboto">
      <SEO 
        title="Ремонт гидравлики сваебойных установок | ACA Hydraulic"
        description="Диагностика и ремонт гидравлики сваебойных установок: насосы, лебёдки, гидромоторы, цилиндры мачты и блоки управления. Выезд по Казахстану согласовывается после обращения."
        keywords="ремонт сваебойной установки, ремонт гидравлики копра, ремонт гидромолота, диагностика сваебойной установки"
        canonical="/services/piledriver-repair"
      />
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl">
            <div className="inline-flex items-center gap-2 bg-[#FFC000]/10 border border-[#FFC000]/20 px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-[#FFC000] font-bebas text-sm tracking-wide">СВАЕБОЙНЫЕ УСТАНОВКИ: ДИАГНОСТИКА И РЕМОНТ</span>
            </div>
            <h1 className="font-bebas text-5xl md:text-7xl text-white mb-6 leading-none tracking-wide">
              Ремонт гидравлики<br/>
              <span className="text-[#FFC000]">сваебойных установок</span>
            </h1>
            <p className="text-xl text-gray-400 mb-8 max-w-2xl font-roboto">
              Проверяем подъём мачты, лебёдки, привод рабочего оборудования и управление гидросистемой. Причину отказа подтверждаем замерами до согласования ремонта.
            </p>
      ...
      <section className="py-20 bg-[#0a0a0a]">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            {[
              { title: "Мачта и цилиндры", items: ["Проверка подъёма и удержания", "Поиск наружных утечек", "Проверка цилиндров", "Контроль клапанов безопасности"] },
              { title: "Лебёдки и гидромоторы", items: ["Проверка тяги и скорости", "Замер давления под нагрузкой", "Оценка дренажных утечек", "Дефектовка агрегата"] },
              { title: "Насосы и управление", items: ["Проверка подачи насоса", "Диагностика регулятора", "Распределители и клапаны", "Настройка после ремонта"] },
              { title: "Рабочий контур", items: ["Гидромолот или вибропогружатель", "Рукава высокого давления", "Соединения и трубопроводы", "Испытание рабочих движений"] }
            ].map((service, idx) => (
      ...
      <section className="py-20 bg-[#FFC000]">
        <div className="container mx-auto px-4 text-center">
          <h2 className="font-bebas text-4xl md:text-6xl text-black mb-6">
            Нужна диагностика <span className="bg-black text-[#FFC000] px-3">сваебойной установки?</span>
          </h2>
          <p className="text-lg text-black mb-8 font-semibold">
            Пришлите модель установки, фото шильдиков насосов и гидромоторов, описание отказа и местонахождение. Состав первичной проверки согласуем заранее.
          </p>
