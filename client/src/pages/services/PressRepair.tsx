...
export default function PressRepair() {
  ...
  return (
    <div className="min-h-screen bg-[#111111] text-white font-roboto pt-20">
      <div className="container mx-auto px-4 py-4 text-sm text-gray-500">
        ...
        <span className="mx-2">/</span>
        <span className="text-white">Ремонт промышленных прессов</span>
      </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-[#1a1a1a] p-6 rounded border border-white/10 hover:border-[#FFC000]/30 transition-colors">
              ...
              <h3 className="font-bebas text-2xl uppercase mb-3">Гидравлические прессы</h3>
              <p className="text-gray-400 leading-relaxed">
                Насосные станции, гидроцилиндры, распределители. Восстановление рабочего давления и усилия прессования.
              </p>
            </div>
            ...
            <div className="bg-[#1a1a1a] p-6 rounded border border-white/10 hover:border-[#FFC000]/30 transition-colors">
              ...
              <p className="text-gray-400 leading-relaxed">
                Пропорциональные клапаны, сервоприводы, датчики давления. Диагностика и настройка систем.
              </p>
            </div>
            ...
            <div className="bg-[#1a1a1a] p-6 rounded border border-white/10 hover:border-[#FFC000]/30 transition-colors">
              ...
              <p className="text-gray-400 leading-relaxed">
                Мобильные бригады выезжают на производства. Ремонт на месте без остановки производственного цикла.
              </p>
            </div>
          </div>
        </div>
      ...
      <Dialog open={isFormOpen} onOpenChange={setIsFormOpen}>
        <DialogContent className="bg-[#1a1a1a] text-white border-white/10">
          ...
          <form className="space-y-4">
            ...
            <div>
              <Label htmlFor="equipment">Модель пресса</Label>
