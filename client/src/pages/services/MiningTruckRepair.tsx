...
export default function MiningTruckRepair() {
  const [isLeadFormOpen, setIsLeadFormOpen] = useState(false);

  return (
    <div className="min-h-screen bg-[#111111] text-white font-roboto">
      <SEO 
        title="Ремонт гидравлики карьерных самосвалов | ACA Hydraulic"
        description="Диагностика и ремонт гидравлики карьерных самосвалов: подъём кузова, рулевое управление, насосы, распределители и цилиндры. Выезд по Казахстану согласовывается после обращения."
        keywords="ремонт карьерного самосвала, ремонт гидравлики самосвала, ремонт цилиндра подъёма кузова, диагностика рулевой гидравлики"
        canonical="/services/mining-truck-repair"
      />
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl">
            <div className="inline-flex items-center gap-2 bg-[#FFC000]/10 border border-[#FFC000]/20 px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-[#FFC000] font-bebas text-sm tracking-wide">КАРЬЕРНЫЕ САМОСВАЛЫ: ДИАГНОСТИКА И РЕМОНТ</span>
            </div>
            <h1 className="font-bebas text-5xl md:text-7xl text-white mb-6 leading-none tracking-wide">
              Ремонт гидравлики<br/>
              <span className="text-[#FFC000]">карьерных самосвалов</span>
            </h1>
            <p className="text-xl text-gray-400 mb-8 max-w-2xl font-roboto">
              Проверяем контуры подъёма кузова и рулевого управления, температуру масла, насосы, клапаны и цилиндры. Объём ремонта определяем по результатам диагностики.
            </p>
      ...
      <section className="py-20 bg-[#0a0a0a]">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            {[
              { title: "Подъём кузова", items: ["Замер давления", "Проверка распределителя", "Диагностика подъёмных цилиндров", "Контроль удержания кузова"] },
              { title: "Рулевое управление", items: ["Проверка усилия и реакции", "Насос рулевого контура", "Клапаны приоритета", "Рулевые цилиндры"] },
              { title: "Насосы и клапаны", items: ["Оценка подачи", "Проверка под нагрузкой", "Дефектовка снятого узла", "Согласование ремонта и деталей"] },
              { title: "Масло и охлаждение", items: ["Контроль температуры", "Проверка фильтрации", "Осмотр теплообменника", "Поиск источника загрязнения"] }
            ].map((service, idx) => (
      ...
      <section className="py-20 bg-[#FFC000]">
        <div className="container mx-auto px-4 text-center">
          <h2 className="font-bebas text-4xl md:text-6xl text-black mb-6">
            Нужна диагностика <span className="bg-black text-[#FFC000] px-3">карьерного самосвала?</span>
          </h2>
          <p className="text-lg text-black mb-8 font-semibold">
            Пришлите модель машины, фото шильдика гидроузла, описание симптомов и местонахождение. Условия выезда и последовательность проверки согласуем после получения данных.
          </p>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-500 text-sm">
                ...
                <li className="flex items-center gap-2">
                  ...
                  <a href="https://wa.me/77714177925" className="hover:text-[#FFC000] transition-colors">WhatsApp</a>
                </li>
                <li className="flex items-center gap-2">
