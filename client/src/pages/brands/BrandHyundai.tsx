...
const hyundaiModels = [
  { model: "Hyundai R200 / R210 / R220", desc: "Гидронасосы, гидромоторы хода и поворота" },
  { model: "Hyundai R290 / R320 / R360", desc: "Главные насосы, распределители, гидроцилиндры" },
  { model: "Hyundai R480 / R520", desc: "Крупные карьерные экскаваторы" },
  { model: "Hyundai HL730 / HL740 / HL760", desc: "Гидравлика колёсных погрузчиков" },
  { model: "Hyundai HD270 / HD320", desc: "Гидравлика карьерных самосвалов" },
  { model: "Hyundai HX235 / HX300", desc: "Новые серии — полный спектр ремонта" },
];

const services = [
  "Ремонт и восстановление гидронасосов Hyundai",
...
export default function BrandHyundai() {
  ...
  const handleWhatsApp = () => {
    ...
    window.open(`https://wa.me/${WHATSAPP_NUMBER}?text=Здравствуйте! Нужен ремонт гидравлики Hyundai.`, "_blank");
  };

  return (
    <div className="min-h-screen bg-[#111111] text-white font-roboto">
      <SEO
        title="Ремонт гидравлики Hyundai в Астане | ACA Hydraulic"
        description="Ремонт гидравлики Hyundai в Астане и Казахстане. Экскаваторы R200/R290/R360/R480, погрузчики HL. Выездной сервис 24/7. Гарантия качества. ☎ +7 (771) 417-79-25"
        keywords="ремонт гидравлики Hyundai, ремонт Hyundai Астана, ремонт гидронасоса Hyundai R200, ремонт Hyundai R290, сервис Hyundai Казахстан, ремонт экскаватора Hyundai"
        canonical="/brands/hyundai"
        breadcrumbs={[
          { name: "Бренды", url: "/services" },
          { name: "Hyundai", url: "/brands/hyundai" },
        ]}
        serviceSchema={{
          serviceName: "Ремонт гидравлики Hyundai",
          serviceDescription: "Ремонт гидравлики спецтехники Hyundai в Астане. Экскаваторы R, погрузчики HL, карьерные самосвалы HD.",
          serviceUrl: "/brands/hyundai",
          areaServed: ["Астана", "Казахстан"],
        }}
        faq={[
          {
            question: "Сколько стоит ремонт гидронасоса Hyundai R200?",
            answer: "Ремонт главного гидронасоса Hyundai R200 стоит от 90 000 до 180 000 тенге в зависимости от характера неисправности. Диагностика бесплатна при последующем ремонте.",
          },
          {
            question: "Ремонтируете ли новые серии Hyundai HX?",
            answer: "Да, ремонтируем как классические серии R, так и новые серии HX. Имеем опыт работы с техникой Hyundai всех поколений.",
          },
          {
            question: "Выезжаете ли на ремонт Hyundai на объект?",
            answer: "Да, выезжаем на ремонт Hyundai прямо на строительный объект или карьер. Оснащены мобильной мастерской. Работаем по всему Казахстану 24/7.",
          },
        ]}
      />
      ...
      <section className="pt-24 pb-16 bg-gradient-to-b from-black to-[#111111]">
        <div className="container mx-auto px-4">
          <nav className="text-sm text-white/50 mb-6">
            ...
            <span className="mx-2">/</span>
            <span className="text-white/80">Hyundai</span>
          </nav>
          <div className="max-w-4xl">
            <div className="inline-flex items-center gap-2 bg-[#FFC000]/10 border border-[#FFC000]/30 rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-[#FFC000] text-sm font-medium">Специализация: Hyundai</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
              Ремонт гидравлики<br />
              <span className="text-[#FFC000]">Hyundai</span><br />
              в Астане
            </h1>
            <p className="text-xl text-white/70 mb-8 max-w-2xl">
              Профессиональный ремонт гидравлических систем спецтехники Hyundai. Экскаваторы R, погрузчики HL, карьерные самосвалы HD. Выездной сервис 24/7 по Казахстану.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              { icon: <Shield className="w-6 h-6 text-[#FFC000]" />, title: "Гарантия 6 месяцев", desc: "Даём гарантию на все виды ремонта гидравлики Hyundai" },
              { icon: <Wrench className="w-6 h-6 text-[#FFC000]" />, title: "Опыт 10+ лет", desc: "Специализируемся на гидравлике Hyundai более 10 лет" },
            ].map((item, i) => (
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-10">Что мы <span className="text-[#FFC000]">ремонтируем</span> в Hyundai</h2>
      ...
      <section className="py-16 bg-[#1a1a1a]">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-10">Модели <span className="text-[#FFC000]">Hyundai</span>, с которыми работаем</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {hyundaiModels.map((item, i) => (
      ...
      <section className="py-16 bg-[#FFC000]">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-black mb-4">Нужен ремонт гидравлики Hyundai?</h2>
      ...
      <section className="py-12 bg-[#111111]">
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-wrap gap-3">
            {[{ name: "Caterpillar (CAT)", href: "/brands/cat" }, { name: "Komatsu", href: "/brands/komatsu" }, { name: "Hitachi", href: "/brands/hitachi" }].map((brand) => (
      ...
      <Dialog open={isLeadFormOpen} onOpenChange={setIsLeadFormOpen}>
        <DialogContent className="bg-[#1a1a1a] border-white/10 text-white max-w-lg">
          <DialogHeader><DialogTitle className="text-white">Заявка на ремонт Hyundai</DialogTitle></DialogHeader>
