  ...
  return <main className="min-h-screen bg-[#101010] py-10 text-white md:py-16">
    ...
    <div className="container mx-auto max-w-6xl px-4">
      ...
      <section className="mt-14 grid gap-8 md:grid-cols-2">
        <div><h2 className="text-3xl font-bold">Насос и маркировка</h2><p className="my-5 leading-relaxed text-gray-300">На фотографии насоса читается каталожный номер 267-2755. В официальном каталоге CAT для этого номера указана модель 432E. Для следующего заказа сверяем конкретное исполнение по данным вашей машины.</p><a href="https://parts.cat.com/en/catcorp/product/267-2755" target="_blank" rel="noopener noreferrer" className="inline-flex min-h-11 items-center text-[#FFC000] underline">Номер 267-2755 в каталоге CAT</a><img src={sale.image} alt="Шильдик проданного насоса: каталожный номер 267-2755" width={864} height={1152} loading="lazy" className="mt-5 max-h-[520px] w-full rounded-lg bg-[#181818] object-contain" /></div>
