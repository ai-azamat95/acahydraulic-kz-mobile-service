...
const articles = [
  ...
  {
    id: 2,
    title: "Падает давление в гидросистеме экскаватора: что проверять",
    excerpt:
      "Как отличить общую проблему гидросистемы от неисправности отдельного контура: симптомы, измерения на холодную и горячую и порядок диагностики без замены узлов наугад.",
    date: "2026-01-25",
  ...
  {
    id: 4,
    title: "Не работает гидравлика спецтехники: 10 признаков",
    excerpt:
      "Проблемы по гидравлике: слабая работа, шум, перегрев, утечки и рывки. Что проверить безопасно и какие данные подготовить для диагностики.",
    date: "2025-12-20",
  ...
  {
    id: 6,
    title: "Ремонт SHANTUI SD32: диагностика гидравлики перед капремонтом",
    excerpt:
      "Что проверить до заказа деталей: давление, насосы, гидромоторы, распределитель, цилиндры и загрязнение системы. На странице также размещена ссылка на реальный кейс поставки двигателя Cummins NTA855.",
    date: "2026-03-18",
    displayDate: "18.03.2026",
    author: "Инженер ACA Hydraulic",
