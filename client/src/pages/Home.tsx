      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-b from-black/90 to-transparent pt-2 pb-2 px-4 md:pt-3 md:pb-3">
        <div className="container mx-auto flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="tel:+77714177925" onClick={() => window.gtag('event', 'conversion', {'send_to': 'AW-17847190636/gJzYCKDa2vgbEOyImr5C'})} className="hidden md:flex items-center gap-2 bg-[#1a1a1a]/80 px-4 py-2 rounded border border-white/10 hover:border-[#FFC000]/50 transition-colors group">
              ...
              <SheetContent side="right" className="bg-[#111111] border-l border-white/10 p-0 w-[300px]">
                <div className="flex flex-col h-full">
                  ...
                  <div className="mt-auto p-6 border-t border-white/10">
                    <a href="tel:+77714177925" onClick={() => window.gtag('event', 'conversion', {'send_to': 'AW-17847190636/gJzYCKDa2vgbEOyImr5C'})} className="flex items-center gap-3 text-[#FFC000] mb-4">
      ...
      <section className="py-20 bg-[#FFC000] text-black">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-4">
            <a 
              href="tel:+77714177925" 
              onClick={() => { window.gtag('event', 'conversion', {'send_to': 'AW-17847190636/gJzYCKDa2vgbEOyImr5C'}); fireTikTokContact('phone'); }}
            ...
            <div>
              ...
              <ul className="space-y-4 text-gray-400 text-sm">
                ...
                <li className="flex items-center gap-3">
                  ...
                  <a href="tel:+77714177925" onClick={() => window.gtag('event', 'conversion', {'send_to': 'AW-17847190636/gJzYCKDa2vgbEOyImr5C'})} className="hover:text-[#FFC000] transition-colors">+7 (771) 417-79-25</a>
                </li>
                <li className="flex items-center gap-3">
